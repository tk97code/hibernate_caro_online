 ...
 */
package allan.client.controller;

import allan.client.RunClient;
import allan.client.model.ChatItem;
import allan.client.model.PlayerInGame;
import allan.client.model.ProfileData;
import allan.client.view.scene.MainMenu;
import allan.shared.helper.MyHash;
...
import allan.server.game.caro.History;
...
public class SocketHandler {
            ...
            try {
                ...
                switch (type) {
                    ...
                    case GAME_EVENT:
                        ...
                        break;
                    case UPDATE_ROOM:
                        onReceiveUpdateRoom(received);
                        break;
                    case SYNC_TIME:
                        onReceiveSyncTime(received);
                        break;
                    case EXIT:
                        running = false;
                }
    ...
    private void onReceiveJoinRoom(String received) {
        ...
        if (RunClient.inGameScene.getPlayer2() != null) {
            RunClient.inGameScene.setIsWaiting(false);
        }
    ...
    private void onReceiveDataRoom(String received) {
        ...
        if (status.equals("failed")) {
            ...
            System.out.println("p1: " + p1.getEmail());
            System.out.println("p2: " + p2.getEmail());
    ...
    private void onReceivedEditProfile(String received) {
        ...
        if (status.equals("failed")) {
            ...
            // load lại thông tin cá nhân mới 
    ...
    public void onReceiveUpdateRoom(String received) {
        int index = 1;
        String[] splitted = received.split(";");
...
//        String gender = splitted[5];
    ...
    public void onReceiveSyncTime(String received) {
        RunClient.inGameScene.setIsWaiting(false);
        RunClient.inGameScene.startGame(30, 10*60);
    }
    ...
    private void initSecurityAES() {
        ...
        RSA clientSideRSA = new RSA()
                .preparePublicKey("D:\\IntelliJ_Java\\hibernate_caro_online\\src\\main\\java\\allan\\server\\rsa_keypair\\publicKey");
